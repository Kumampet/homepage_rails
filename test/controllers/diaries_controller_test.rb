...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post diaries_url, params: { diary: { Content: @diary.Content, Photo: @diary.Photo, Title: @diary.Title } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { Content: @diary.Content, Photo: @diary.Photo, Title: @diary.Title } }
